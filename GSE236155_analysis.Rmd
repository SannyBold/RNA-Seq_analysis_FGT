...
```
All steps in the pipeline uses code adapted from the Functional Genomic Technologies class materials
...
#loaded The alignment and annotations of the RNA-sea experiment, assumes current directory is ICA
